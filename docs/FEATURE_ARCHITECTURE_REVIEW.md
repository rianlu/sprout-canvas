...
| 部署与持续验证 | Node 104 项, 上轮完整浏览器各 89 组及本轮相关浏览器各 46 组, Docker 13 项及本机实际升级验收通过; 本机已更新至本次实现, 公网隧道网络异常待恢复 | 检查 WiFi 的 IPv6 出站与代理路径后重新验证公网入口; 推送后核对对应提交的远端 Verify; 迁至其他部署环境时单独验收 |
