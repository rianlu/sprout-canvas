...
| 部署与持续验证 | Node 105 项, 本次完整浏览器 101 组及 Linux 相关回归 28 组, Docker 13 项及本机实际升级验收通过; 公网当前返回 Cloudflare 1033, 隧道边缘连接超时 | 检查 WiFi 的 IPv6 出站与代理路径后重新验证公网入口; 推送后核对对应提交的远端 Verify; 迁至其他部署环境时单独验收 |
